...
export const ResourcesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <section className="bg-gradient-to-br from-lli-teal to-lli-teal-dark py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white rounded-xl shadow-2xl p-12">
            <div className="text-6xl mb-6">📚</div>
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              Download the Complete Resource Library Workbook
            </h2>
            <p className="text-lg text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto">
              Get instant access to all 46 resources in a single, print-ready workbook format. 
              Perfect for workshops, team development sessions, or personal professional growth.
            </p>
            
            <div className="grid md:grid-cols-4 gap-4 mb-8 text-left">
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="text-lli-teal font-bold text-2xl mb-1">12</div>
                <div className="text-sm text-gray-600">Leadership Resources</div>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="text-lli-teal font-bold text-2xl mb-1">18</div>
                <div className="text-sm text-gray-600">DEI & Culture Tools</div>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="text-lli-teal font-bold text-2xl mb-1">9</div>
                <div className="text-sm text-gray-600">Change Management</div>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="text-lli-teal font-bold text-2xl mb-1">7</div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center justify-center gap-3 text-gray-700">
                <i className="fas fa-check-circle text-lli-teal text-xl"></i>
                <span>Complete table of contents with page numbers</span>
              </div>
              <div className="flex items-center justify-center gap-3 text-gray-700">
                <i className="fas fa-check-circle text-lli-teal text-xl"></i>
                <span>Note-taking space for each resource</span>
              </div>
              <div className="flex items-center justify-center gap-3 text-gray-700">
                <i className="fas fa-check-circle text-lli-teal text-xl"></i>
                <span>Print-optimized format (8.5" × 11")</span>
              </div>
              <div className="flex items-center justify-center gap-3 text-gray-700">
                <i className="fas fa-check-circle text-lli-teal text-xl"></i>
                <span>Professional design ready for workshops</span>
              </div>
            </div>
